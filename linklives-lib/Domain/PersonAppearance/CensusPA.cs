...
namespace Linklives.Domain
{
    ...
    public class CensusPA : BasePA
    {
        ...
        protected override void InitSourceSpecificFields()
        {
            ...
            {
                Sourceplace_searchable = string.Join(' ', new string[] { Transcribed.Sogn, Transcribed.Herred, Transcribed.Amt });
            }
            Occupation_searchable = Transcribed.Stilling_i_husstanden;
